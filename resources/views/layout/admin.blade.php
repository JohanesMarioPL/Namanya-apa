...
@if(request()->is('/'))
    <body>
    <header class="lg:px-16 px-6 bg-white flex flex-wrap items-center justify-between shadow fixed top-0 w-screen z-20 min-w-full">
        @else
            <body>
            <header class="lg:px-16 px-6 bg-white flex flex-wrap items-center justify-between shadow fixed top-0 w-screen z-20">
                ...
                <div class="hidden lg:flex lg:items-center lg:pb-0 lg:w-auto lg:gap-5 lg:mb-0 lg:shadow-none lg:px-0 w-full pb-2 px-2 shadow-xl lg:border-b-0 " id="menu">
                    <div>
                        <nav>
                            <ul class="lg:flex lg:mb-0 items-center justify-between text-base text-gray-700 pt-4 mb-2 lg:pt-0">
                                <li><a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400" href="admin/create-polling">Create Polling</a></li>
                                <li><a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400" href="admin/user">User</a></li>
                                <li><a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400" href="admin/mata-kuliah">Mata Kuliah</a></li>
                                <li><a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400" href="admin/profile">Profile</a></li>
                                <!-- <li>
